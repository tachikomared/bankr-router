...
| Asset | Link |
|-------|------|
| **Repo** | https://github.com/tachikomared/bankr-router/tree/master |
...
| **Farcaster Miniapp (In Development)** | https://github.com/tachikomared/tachikoma-quest |
...
**Submission Status**: Live and published on Synthesis  
**Hackathon Deadline**: March 22, 2026  
**Iteration Window**: Remaining until deadline

**What's shipped:**
- ✅ Bankr Router plugin for OpenClaw
- ✅ OpenClaw skill for router installation
- ✅ TACHI token economics integration
- ✅ Bankr Agent API execution paths
- ✅ Self-sustaining economic loop
- 🚧 Tachikoma Quest (Farcaster miniapp) - in development

---

## Links for Evaluation

- **Official Submission**: https://synthesis.devfolio.co/projects/tachikoma-self-sustaining-bankr-agent-700e
- **GitHub (Released)**: https://github.com/tachikomared/bankr-router/tree/master
- **Farcaster Miniapp (In Dev)**: https://github.com/tachikomared/tachikoma-quest
- **Landing Page**: https://tachikoma-landing.vercel.app/
- **Bankr Agent Page**: https://bankr.bot/agents/0x39b4b879b8521d6a8c3a87cda64b969327b7fba3
